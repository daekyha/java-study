...
class 사람{
	...
	void 배달_음식_주문하다() {
		this.a좋아하는_음식점.배달_음식_주문하다(this.이름,this.전화번호,this.선호하는_음식의_매운정도,this.선호하는_음식);
	}
}
...
class 반점{
	void 배달_음식_주문하다(String 이름,String 전화번호,String 맵기, String 선호음식) {
		
	}
}
class 영화반점 extends 반점{
void 배달_음식_주문하다(String 이름,String 전화번호,String 맵기, String 선호음식) {
		System.out.printf("영화반점에서 %s(%s)에게 %s(을)를 배달합니다.\n",이름,전화번호,맵기,선호음식);
	}
}
class 북경반점 extends 반점{
void 배달_음식_주문하다(String 이름,String 전화번호,String 맵기, String 선호음식) {
	System.out.printf("북경반점에서 %s(%s)에게 %s(을)를 배달합니다.\n",이름,전화번호,맵기,선호음식);
	}
}